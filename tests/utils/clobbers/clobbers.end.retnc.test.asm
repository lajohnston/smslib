describe "utils.clobbers.end.retnc"
    .redefine utils.registers.AUTO_PRESERVE 1

    test "does not restore or return when carry is set"
        zest.initRegisters
        call +
...
describe "utils.clobbers.end.retnc with nothing to restore"
