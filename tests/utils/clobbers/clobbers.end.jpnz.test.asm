describe "utils.clobbers.end.jpnz"
    test "when Z - does not jump or restore"
        ...
        utils.preserve "af" "bc" "de" "hl" "ix" "iy" "i" "af'" "bc'" "de'" "hl'"
            utils.clobbers.withBranching "af" "bc" "de" "hl" "ix" "iy" "i" "af'" "bc'" "de'" "hl'"
                ...
                ; This shouldn't jump
                utils.clobbers.end.jpnz suite.registers.unexpectedJump
...
describe "utils.clobbers.end.jpnz with nothing to restore"
    test "when Z - does not jump or restore"
        zest.initRegisters
